...
export const userSlice = createSlice({
  ...
  reducers: {
    ...
    updateAddress: (state, action) => {
      const updatedAddress = action.payload; // The updated address object from the API response
      const addresses = [...(state?.userInfo?.addressList ?? [])]; // Clone the current address list
      ...
      return {
        ...
        userInfo: {
          ...state.userInfo,
          addressList: addresses, // Update the address list
        },
      };
    },
